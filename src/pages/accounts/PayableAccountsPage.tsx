    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">R$ 2.840,00</div>
            <p className="text-xs text-muted-foreground">
              3 contas vencendo
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">R$ 8.650,00</div>
            <p className="text-xs text-muted-foreground">
              15 contas pagas
            </p>
          </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p>Funcionalidade de contas a pagar em desenvolvimento</p>
            <p className="text-sm">Em breve você poderá gerenciar todas suas contas a pagar aqui</p>
          </div>
        </CardContent>
      </Card>
    </div>
